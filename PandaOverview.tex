...
PanDA' data model uses events as the unit of data\mtnote{Is event an abstraction
specific to the MD workflow?}. Each event represents a collision captured in the
...
% \mtnote{This diagram is a placeholder. I am working on a substitute
...
% databases; green arrows http messaging interfaces; red arrows API; purple
% arrows database communications.
}
