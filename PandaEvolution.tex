...
% amount of work nodes that cannot be given to any other job.
any other job in the Titan's queue\sergeynote{any other job currently in the
Titan's queue?}\mtnote{Better?}. Usually, backfill availability is a fraction of
...
use that term to name the pilot of NGE. Would PanDA Broker work?}
