...
opportunistic use of supercomputers as well as commercial and academic clouds.
...
HERWIG~\cite{corcella2001herwig} and many others. \mtnote{Addresses Alexei's comment. Is the following sentence correct?} The detector simulator is
called Geant4~\cite{agostinelli2003geant4} and simulates both the ATLAS detector and it's interaction physical processes.
...
on for digitalization where hits are further process to mimic the readout of the
...
use that term to name the pilot of NGE. Would PanDA Broker work?}\sergeynote{OK
broker it is for this paper.}
