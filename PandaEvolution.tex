...
\mtnote{Currently, is PanDA running event generation, detector simulation or
both on Titain?}
\mtnote{Please provide a diagram illustrating event generation and detector
simulation stats compared to the whole ATLAS computation activity.}
