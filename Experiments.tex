...
execution time of AthenaMP, and the pilot overhead as function of the
pilot size.
...
We ran pilots with 256, 512, 1024 and 2048 worker nodes and 3\mtnote{2?}
...
\begin{figure}[!t]
        ...
        \vspace{-0.3in}
    \caption{Weak scalability with multiple generations (where each generation has approximately 1/6th the number of events compared to Fig. 7): average pilot
...
512, 1024 and 2048 nodes. Thus, the number of AthenaMP generations is equal to
eight times the size of the smallest pilot and corresponds to the size of the
largest pilot. As a consequence, the number of consecutive generations of
