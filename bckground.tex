...
% 	or proxy infrastructure [ACTATLAS,ACTHYDRA] is not discussed.\mtnote{I
% 	looked for these models and found few references to them. All in all, I
% 	am not seeing how these fit within the background of pilot-enabled
% 	workload managers.}\jhanote{As you've exercised diligence in checking, we
% 	should ignore these suggestions (which are at best advisory, not
% 	mandatory)}
% \end{itemize}
% \fi
