...
difficult to compare}\mtnote{What dimension(s) should we use to argue that WMS are difficult to compare?}
...
practice paper and not a traditional research paper?}\mtnote{Fine with me.}
