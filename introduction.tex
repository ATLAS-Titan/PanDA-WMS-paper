...
system, demand for computing systems will significantly outstrip current and projected supply. %(availability).
...
% As the community looks forward to designing the next generation of online
% analytical platforms~\cite{foap-url}, this project provides some 
