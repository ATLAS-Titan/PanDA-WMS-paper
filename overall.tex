...
\begin{figure}[htp]
    ...
    62175 times: mean number of work nodes available 680 (yellow line); mean
...
% -----------------------------------------------------------------------------
\subsection{Efficiency, Scalability, and Reliability of Detector Simulation on Titan}
\label{ssec:panda_titan}
...
\begin{figure}[htp]
    ...
    Performance per core: BNL 1.126; SIGNET 0.885; Titan 0.577.\mtnote{TO BE DELATED.}}
