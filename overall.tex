...
ATLAS jobs are file read I/O heavy, as can be seen in
...
writing this paper. {\sarp{can someone take a look at this? I would expect at
least similar values for number of opens and closes and there is vast
difference. Can it be that ATLAS jobs do a lot of opens without following
closes, or perhaps multiple opens for the same files over and over?}}
