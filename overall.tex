...
window. The brokers reached 18\% average efficiency, with a minimum efficiency
of 7.8\% (May 2016) and a maximum efficiency of 30.9\% (Feb. 2017, excluding
the preliminary results of March). The total backfill availability was 20.3M
in April 2016, and 17.6M in February 2017. This suggests that the differences
in efficiency did not depend on a comparable difference in the total backfill
availability. \jhanote{change last sentence to: ... efficiency does not depend on total backfill availability." ??}
